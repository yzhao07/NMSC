...
```{r}
Fig2 = ggarrange( ggarrange(arm_plot2,ncol = 2,widths = c(1,0.2)),ggarrange(pcall,pc1,pc2,pc3,nrow = 1,ncol =4,widths=c(1,1,1,1.48)),D,
                   nrow = 3,heights  = c(1.4,1,1),labels=c("A","B","C"))
ggsave(Fig2,file="../analysis/Graph/Fig2_v2.pdf", width=15, height=11)
